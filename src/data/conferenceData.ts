...
export const conferenceData = {
  ...
  scientificCommittee: [
    "الدكتور علي حيتوف",
    "الدكتور سعد بناني ضوس",
    "الدكتورة رشيدة كوجيل",
    "الدكتور عمر بوسلات",
    "الدكتور محمد الأنصاري",
    "الدكتور محمد جنان",
    "الدكتور محمد البغدادي",
    "الدكتورة كريمة حليم",
    "الدكتورة حبيبة أوحادوش",
    "الدكتور مصطفى الرويجل",
    "الدكتور عبد القادر زريق",
    "الدكتورة هاجر دحمة",
    "الدكتورة خديجة الدحماني",
    "الدكتور عثمان زكرياء",
    "الدكتور عبد العزيز ربيع",
    "الدكتورة جيهان العروسي",
    "الدكتورة نور الهدى بلغيثة",
    "الدكتورة حبيبة توزاني إدريسي",
    "الدكتور أنور قارة",
    "الدكتور عبد العزيز ناجح",
    "الدكتور يوسف بوطاهر",
    "الدكتور سعيد حليم",
],
designCommittee:[
  ...
  day2Schedule: [
    ...
    {
      time: "12:00",
      title: { ar: "عروض تقديمية من الطلبة", fr: "Présentations d'étudiants" },
      type: "talk",
    },
    {
      time: "14:00",
